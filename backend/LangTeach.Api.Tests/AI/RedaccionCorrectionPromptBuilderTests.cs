...
public class RedaccionCorrectionPromptBuilderTests
{
    ...
    [Fact]
    public void Build_SetsMaxTokensTo16384_ToPreventTruncationOnLongTexts()
    {
        // Issue #1217: raised to 8192; #1219: raised to 16384 because verbose responses (with
        // post-JSON prose generated by the OFFSETS procedure) exceed 8192 output tokens.
        var req = _builder.Build(MakeCtx());
        req.MaxTokens.Should().Be(16384);
    }
