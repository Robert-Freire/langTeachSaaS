...
public class PromptService : IPromptService
{
    ...
    public ClaudeRequest BuildReflectionExtractionPrompt(ReflectionExtractionContext ctx)
    {
        ...
        var system = $"""
            ...
            - groupMention: string or null — the exact name or spoken reference the teacher used for a group of students ("el grupo del lunes", "Lunes", "los del lunes", "be uno punto uno", "mis alumnos del lunes"). Extract verbatim as spoken. Set to null when the transcript clearly targets a single student by name and gives no indication of a group context. Do not resolve to a group ID; resolution happens server-side.
