...
const mockStudents: Student[] = [
  { id: 's1', name: 'Alice', learningLanguage: 'English', cefrLevel: 'B1', interests: [], personalNotes: null, teachingNotes: null, nativeLanguages: [], learningGoals: [], weaknesses: [], difficulties: [], createdAt: '', updatedAt: '' },
  { id: 's2', name: 'Bob', learningLanguage: 'Spanish', cefrLevel: 'A2', interests: [], personalNotes: null, teachingNotes: null, nativeLanguages: [], learningGoals: [], weaknesses: [], difficulties: [], createdAt: '', updatedAt: '' },
]
