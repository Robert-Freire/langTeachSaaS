...
export function GeneratePanel({
  ...
  return (
    ...
    >
      ...
      {isStreaming && (
        <div className="flex items-center gap-3 rounded-md bg-white border border-indigo-100 px-4 py-5" data-testid="generate-output">
      ...
      {isDone && output && (() => {
        ...
        const renderer = getRenderer(taskType as ContentBlockType)
        return (
