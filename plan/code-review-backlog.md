...
| t755 / architecture-reviewer | info | 10 visual spec files still default `VITE_API_BASE_URL` to `http://localhost:5178`. This is intentional: the visual stack (start-visual-stack.sh) exposes the API on port 5178 by design. Not a bug; no change needed. |
