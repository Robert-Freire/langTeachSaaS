...
| #151 | 2026-03-22 | Important | CourseNew student selector may show raw UUID in the trigger after selection in the e2e environment (Radix Select value vs label rendering); needs investigation on whether this is environment-specific or a real regression |
