...
| #1401 | 2026-05-31 | low | Arch: MapSessionToUpdateRequest and TryDeserialize<T> now duplicated verbatim in GroupSessionLogsController.cs and SessionLogsController.cs. Extract to shared static helper when a third PATCH endpoint is added. |
